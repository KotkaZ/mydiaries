 ...
 */
public class DefaultTableOld<T> {
    private List<LocalDate> inputDate = new ArrayList<>();
    private List<T> tabelData = new ArrayList<>();


    public DefaultTableOld(List<LocalDate> inputDate, List<T> tabelData) {
        this.inputDate = inputDate;
        this.tabelData = tabelData;
    }

    public DefaultTableOld() {
    }
    ...
    public void loadTable(String fileName) throws IOException {
        ...
        try (final JsonReader jsonReader = new JsonReader(new FileReader(fileName))) {
            DefaultTableOld<T> defaultTable = gson.fromJson(jsonReader, this.getClass());
    ...
    public void saveTabel(String fileName) throws IOException {
        ...
        final Type REVIEW_TYPE = new TypeToken<DefaultTableOld<T>>() {
        }.getType();
    ...
    public Map<LocalDate, T> getOrderedTable(Comparator<T> comparator) {
